...
import com.ljj.kafka.KafkaEvent;
import com.ljj.kafka.KafkaEventSchema;
import com.ljj.map.BrandLikeMap;
import com.ljj.reduce.BrandLikeReduce;
import com.ljj.reduce.BrandLikeSink;
...
public class BrandlikeTask {
    public static void main(String[] args) {
        ...
        args = new String[]{"--input-topic","scanProductLog","--bootstrap.servers","192.168.2.100:9092","--zookeeper.connect","192.168.2.100:2181","--group.id","user"};
