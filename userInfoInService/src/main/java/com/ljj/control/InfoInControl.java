package com.ljj.control;

import com.alibaba.fastjson.JSONObject;
import com.ljj.entity.ResultMessage;
import com.ljj.log.AttentionProductLog;
import com.ljj.log.BuyCartProductLog;
import com.ljj.log.CollectProductLog;
import com.ljj.log.ScanProductLog;
import com.ljj.utils.ReadProperties;
...
public class InfoInControl {
    ...
    public String helloworld(String recevicelog,HttpServletRequest req){
        ...
        }else if("BuyCartProductLog".equals(classname)){//购物车
        ...
        }else if("CollectProductLog".equals(classname)){//收藏
        ...
        }else if("ScanProductLog".equals(classname)){//浏览
